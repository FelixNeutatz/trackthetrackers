...
import io.ssc.trackthetrackers.extraction.resources.RhinoParserExtractor;
...
public class RhinoParserExtractionIntegrationTest {
  ...
  Iterable<Resource> extractResources(String sourceUrl, URL page) throws IOException {
    return new RhinoParserExtractor().extractResources(sourceUrl, Resources.toString(page, Charsets.UTF_8));
  }
